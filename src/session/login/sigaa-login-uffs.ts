...
import { UFFSPage } from '@session/page/sigaa-page-uffs'; // Certifique-se de ter o módulo UFFSPage disponível
...
export class SigaaLoginUFFS implements Login {
  ...
  protected parseLoginForm(page: UFFSPage): SigaaForm {
  ...
  protected async parseDesktopLoginResult(page: UFFSPage): Promise<UFFSPage> {
